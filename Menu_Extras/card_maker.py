...
def create_card(atk, hp, x, ability_text, description_text):
    ...
    stats_font = ImageFont.truetype(r"C:\Users\Chris\OneDrive\Documents\Discord-Bot\Fonts\TT Rounds Neue Trial Compressed ExtraBold.ttf", size=35)
    title_font = ImageFont.truetype(r"C:\Users\Chris\OneDrive\Documents\Discord-Bot\Fonts\ArsenicaTrial-Extrabold.ttf", size=49)
    abilities_font = ImageFont.truetype(r"C:\Users\Chris\OneDrive\Documents\Discord-Bot\Fonts\TT Rounds Neue Trial Condensed Bold.ttf", size=27)
    description_font = ImageFont.truetype(r"C:\Users\Chris\OneDrive\Documents\Discord-Bot\Fonts\TT Rounds Neue Trial Condensed Bold.ttf", size=8)
